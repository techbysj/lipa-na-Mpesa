...
include_once __DIR__ . DIRECTORY_SEPARATOR."MpesaConfigs.php";
include_once __DIR__ . DIRECTORY_SEPARATOR."MpesaItem.php";
...
class stkPush
{
    ...
    public function mpesaSTKPush()
    {
        ...
        // generate the token
        $this->mpesaItem->setTransactionType('CustomerBuyGoodsOnline');
        ...
        file_put_contents('mpesa-token.log',$result. PHP_EOL,FILE_APPEND);
        ...
        $curl_post_data = array(
          ...
          'PartyB' => $this->mpesaItem->getPartyB(),
        ...
        $fp = file_put_contents('mpesa-request.json', $data_string);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, $data_string);
        $curl_response = curl_exec($curl);
        file_put_contents('mpesa-response.log',$curl_response. PHP_EOL,FILE_APPEND);
        file_put_contents('mpesa-response.log',$this->getRequestInitiateUrl(). PHP_EOL,FILE_APPEND);
